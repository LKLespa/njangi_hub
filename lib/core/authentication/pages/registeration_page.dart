  ...
  Widget build(BuildContext context, WidgetRef ref) {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Card(
                      child: ListTile(
                        leading: const Icon(Icons.camera, size: 20,),
    ...
    Future<void> validateAndProceed() async {
      if (formKey.currentState!.validate()) {
        final bool? userNameExist = await authStateNotifier.checkIfUsernameExist(
            context: context, username: userName.value);

        if (userNameExist != null && !userNameExist) {
          userNameError.value = null;
          authState.copyWith.tempUser!(userName: userName.value, photo: userImage.value, name: userName.value);
          print('');
          if(context.mounted){
